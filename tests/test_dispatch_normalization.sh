...
run_validation() {
  ...
  VALID_STAGES="kickoff clarification design plan execution agent-review deploy-review feedback-implementation follow-up-capture merge closeout"
...
for stage in kickoff clarification design plan execution agent-review deploy-review feedback-implementation follow-up-capture merge closeout; do
  if run_validation "repository_dispatch" \
