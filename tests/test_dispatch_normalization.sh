...
run_validation() {
  ...
  VALID_STAGES="kickoff clarification design plan execution feedback-implementation follow-up-capture review merge closeout"
...
for stage in kickoff clarification design plan execution feedback-implementation follow-up-capture review merge closeout; do
  if run_validation "repository_dispatch" \
